...
public class CategoryHober : MonoBehaviour {
    ...
    private void OnEnable()
    {
        ...
        periodicTable.categories.Add(this);
    }
    ...
    private void selectElement()
    {
        ...
        {
            periodicTable.updateAllColorsTransparency(1);
            isCategorySelected = false;
        }
        else
        {
            periodicTable.setCategorys(categoryField, 0.5f);
